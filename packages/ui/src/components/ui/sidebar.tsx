...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@turbotemplate/ui/components/ui/sheet";
import { Skeleton } from "@turbotemplate/ui/components/ui/skeleton";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@turbotemplate/ui/components/ui/tooltip";
import { useIsMobile } from "@turbotemplate/ui/hooks/use-mobile";
...
type SidebarContextProps = {
  labels: { toggle: string; title: string; description: string; close: string };
...
function SidebarProvider({
  ...
  labels: SidebarContextProps["labels"];
  defaultOpen?: boolean;
  open?: boolean;
...
function Sidebar({
  ...
  const { labels, isMobile, state, openMobile, setOpenMobile } = useSidebar();
